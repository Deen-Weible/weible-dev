...
---
import Photo from "../../components/BlogPhoto.astro"
...
<Photo alt="A bunch of lights and letters strung up on a wall, Stranger Things style" src="/BlogMedia/StrangerThingsLeds"/>
